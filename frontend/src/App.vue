    ...
    <div class="layout-container flex h-full grow flex-col">
      <div class="px-4 sm:px-8 md:px-12 lg:px-16 flex flex-1 justify-center py-5">
        <div class="layout-content-container flex flex-col max-w-screen-xl w-full flex-1 gap-8">
          <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-dark-border px-6 py-4 rounded-xl bg-dark-card shadow-subtle">
            <div class="flex items-center gap-4 text-dark-text">
              ...
              <h1 class="text-dark-text text-xl font-bold leading-tight tracking-tight">ELiS - Reconhecimento OCR</h1>
            </div>
            <div class="flex flex-1 justify-end gap-8">
              <div class="flex items-center gap-9"><a class="text-dark-text-soft text-sm font-medium leading-normal hover:text-dark-primary transition-colors" href="#">About</a></div>
            </div>
          </header>
          <main class="flex flex-col gap-8">
            <div class="flex flex-wrap justify-between items-center gap-4 p-4">
              <div class="flex flex-col gap-2">
                <p class="text-dark-text text-4xl font-bold leading-tight tracking-tighter">Libras Sign Writing OCR</p>
                <p class="text-dark-text-soft text-base font-normal leading-normal">Carregue uma imagem para análise e revisão educacional.</p>
              </div>
            </div>
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-8 items-start">
              <OcrUploader @image-uploaded="handleImageUpload" @perform-ocr="performOcr" :image-preview="imagePreview" />
